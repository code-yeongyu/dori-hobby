...
TOOLS="${DORI_TOOLS:-nds_capture_screen,nds_press_button,nds_touch,nds_press_sequence,nds_advance_dialog,nds_notepad_read,nds_notepad_append,nds_record_event}"
